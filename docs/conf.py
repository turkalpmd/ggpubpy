...
latex_documents = [
    (master_doc, 'ggpubpy.tex', 'ggpubpy Documentation',
     'Izzet Turkalp Akbasli', 'manual'),
]
...
man_pages = [
    (master_doc, 'ggpubpy', 'ggpubpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ggpubpy', 'ggpubpy Documentation',
     author, 'ggpubpy', 'Publication-ready plots for Python',
     'Miscellaneous'),
]
